...
public class ExportPackage {
    ...
    private const string SDK_PLUGIN_PATH = "Assets/Plugins/rum/";
    private const string BASE_PACKAGE_PATCH = "rum-sdk-unity";

    private static string Plugin_Version = com.rum.RUMConfig.VERSION;
